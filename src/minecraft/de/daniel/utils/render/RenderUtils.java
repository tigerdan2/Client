...
import de.daniel.utils.block.BlockUtils;
...
public final class RenderUtils  {
    ...
    public static void makeScissorBox(final float x, final float y, final float x2, final float y2,ScaledResolution s) {
        makeScissorBox(x, y, x2, y2, 1,s);
    }

    public static void makeScissorBox(final float x, final float y, final float x2, final float y2, final float scaleOffset,ScaledResolution sr) {
        final ScaledResolution scaledResolution = sr;
